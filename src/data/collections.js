...
export const GROCERY = [
  ...
  { t: "طحين وأرز وبقوليات", e: "🌾", bg: "#F2EEE5" },
  { t: "زيوت وسكر وبهارات", e: "🫒", bg: "#FBF3E2" },
...
export const SNACKS = [
  ...
  { t: "طعام سريع ومجمّد", e: "🍜", bg: "#FBEFE0" },
  { t: "صلصات ومربى", e: "🥫", bg: "#FBEAE4" },
  { t: "ركن الپان", e: "🍃", bg: "#E9F2E6" },
  { t: "آيس كريم ومثلجات", e: "🍦", bg: "#F1EAF6" },
];
export const HOUSEHOLD = [
  { t: "منزل وديكور", e: "🏠", bg: "#EEF1F4" },
  { t: "منظفات وعناية منزلية", e: "🧽", bg: "#E7F1F2" },
...
export const BEAUTY = [
  { t: "مكياج الشفاه", e: "💋", bg: "#FBEAF0" },
  { t: "مكياج الوجه", e: "💄", bg: "#F6E7EC" },
  { t: "مكياج العيون", e: "👁️", bg: "#F1E7F6" },
  { t: "مكياج الأظافر", e: "💅", bg: "#FBEAF2" },
  { t: "سيرومات وتونر", e: "🧪", bg: "#F0EAF7" },
  { t: "واقيات شمس", e: "☀️", bg: "#FBF3E6" },
  { t: "غسولات ومنظّفات", e: "🧼", bg: "#E9F2EC" },
  { t: "ماسكات الوجه", e: "🎭", bg: "#F6E9EE" },
  { t: "صبغات الشعر", e: "🎨", bg: "#F3E7EE" },
  { t: "ماسكات وسيرومات الشعر", e: "💆‍♀️", bg: "#EFE9F6" },
  { t: "تصفيف الشعر", e: "💇", bg: "#EDE9F6" },
  { t: "شامبو وزيوت", e: "🧴", bg: "#EAF1F8" },
  { t: "أدوات العناية بالجسم", e: "🛁", bg: "#F1E7F0" },
  { t: "إكسسوارات التجميل", e: "🪞", bg: "#F6E7EC" },
  { t: "فرش الشعر", e: "🪮", bg: "#EFEAF6" },
  { t: "عناية نسائية", e: "🌸", bg: "#FBEAF2" },
  { t: "عناية بالطفل", e: "🍼", bg: "#F1E7F0" },
  { t: "تجميل فاخر", e: "✨", bg: "#F3E7EE" },
  { t: "عطور وهدايا", e: "🌷", bg: "#F6E7EC" },
  { t: "عناية الرجال", e: "🧔", bg: "#EAEFF4" },
];
